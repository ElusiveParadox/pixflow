...
def login_page():
    ...
    st.markdown("<p style='color:#94a3b8'>Flow your moments. Share your world.</p>", unsafe_allow_html=True)
...
def feed_page():
    ...
    with st.spinner("Loading feed..."):
        time.sleep(0.3)
        res = requests.get("http://localhost:8000/feed", headers=get_headers())
